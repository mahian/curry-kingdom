        ...
        <div>
            <section className="text-gray-600 bg-red-50 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="grid grid-cols-3 gap-10 sm:-m-4 -mx-4 -mb-10 -mt-4">
                        <div className="p-4 w-full sm:mb-0 mb-6 rounded-lg bg-white shadow-xl">
                            ...
                            <p className="text-base leading-relaxed mt-2">{data1.strInstructions.length >= 100 ? data1.strInstructions.slice(0, 100)+"...": data1.strInstructions}</p>
                            <Link to={`singleFood/${data1.idMeal}`} className=" inline-flex items-center bg-orange-400 py-2 px-5 font-bold text-white rounded-full transition hover:bg-orange-300 mt-3">Learn More
