                    ...
                    <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-10 -m-4">
                        <div className="p-4 shadow-xl w-full">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full">
                                    <h2 className="title-font font-bold text-2xl text-gray-900">Carla Houston</h2>
                        ...
                        <div className="p-4 w-full shadow-xl">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full">
                                    <h2 className="title-font font-bold text-2xl text-gray-900">Andoni Luis Aduriz</h2>
                                    <span className="inline-flex mt-3">
                                        <a className="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                        ...
                        <div className="p-4 w-full shadow-xl">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full">
                                    <h2 className="title-font font-bold text-2xl text-gray-900">Bjorn Frantzén</h2>
                                    <span className="inline-flex mt-3">
                                        <a className="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                        ...
                        <div className="p-4 w-full shadow-xl">
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full">
                                    <h2 className="title-font font-bold text-2xl text-gray-900">Joan Roca</h2>
                                    <span className="inline-flex mt-3">
                                        <a className="text-gray-500">
                                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
