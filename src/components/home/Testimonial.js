                ...
                <div className="mx-auto max-w-[1340px] px-4 py-16 sm:px-6 sm:py-24 lg:mr-0 lg:pl-8 lg:pr-0">
                    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16">
                        <div className="max-w-xl text-center sm:text-left">
                            ...
                            <div className="hidden lg:mt-8 lg:flex lg:gap-4">
                                <button className="prev-button rounded-full border border-primary p-3 text-primary hover:bg-primary hover:text-white">
                                ...
                                <button className="next-button rounded-full border border-primary p-3 text-primary hover:bg-primary hover:text-white">
                        ...
                        <div className="-mx-6 lg:col-span-2 lg:mx-0">
                            <div className="swiper-container !overflow-hidden">
                                <Swiper navigation={{
                                    nextEl: '.next-button',
                                    prevEl: '.prev-button',
                                    }} pagination={true} modules={[Navigation, Pagination]} className="mySwiper">
                                    <SwiperSlide>
                    ...
                    <div className="mt-8 flex justify-center gap-4 lg:hidden">
                        ...
                        <button
                            ...
                            className="next-button rounded-full border border-primary p-4 text-primary hover:bg-primary hover:text-white"
                        >
                            <svg
                                className="h-5 w-5"
                                fill="none"
